                    ...
                    <table class="admin-table" style="margin-top:0; border:none;">
                        ...
                        <tbody>
                            <?php foreach ($categories as $cat): ?>
                                <tr>
                                    <td><span style="font-weight:700; color:#D4AF37; font-size:0.85rem;"><?php echo $cat['display_order']; ?></span></td>
                                    <td style="font-weight:600; color:#fff; font-size:0.88rem;"><?php echo htmlspecialchars($cat['name']); ?></td>
                                    <td><span style="font-size:0.72rem; color:rgba(255,255,255,0.35); font-family:monospace;"><?php echo htmlspecialchars($cat['slug']); ?></span></td>
                                    <td><span class="admin-badge <?php echo $cat['status'] ? 'badge-completed' : 'badge-pending'; ?>"><?php echo $cat['status'] ? 'Active' : 'Inactive'; ?></span></td>
                                    <td>
